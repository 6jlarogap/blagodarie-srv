...
#   Пришлашение в бот: пользователь телеграма велит боту создать
#   сообщение для приглашения собсвенного живого пользователя,
#   содержащее ссылку типа:
#       https://t.me/<имя_бота>?start=<токен>
#   Пользователь передает это сообщение приглашаемому, тот давит
