# Generated by Django 3.2.6 on 2021-10-14 12:03
...
def operation(apps, schema_editor):
    sql = '''create or replace function find_rel_parent_child(v_user_from_id int, v_level int) returns setof template_tmp_parent as 
$$
    ...
    return query 
        insert into tmp_parent
            ...
            where
                ...
                (contact_currentstate.is_parent or contact_currentstate.is_child) and
        ...
        return query 
            insert into tmp_parent
                select
                    ...
                    contact_currentstate.is_parent,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contact', '0059_templatetmpparent'),
    ]
