# Generated by Django 3.2.6 on 2021-12-14 17:45
...
def operation(apps, schema_editor):
    ops = """
drop function if exists find_links_among;
\f
create or replace function find_shortest_relation_path(
    v_user_from_id int,
    v_user_to_id int,
    v_level int
...
$$
    ...
    """
    print('\nCreate template teble and function to find shortest relation path between users')
    for op in ops.split("\n\f\n"):
        sql = op.strip()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contact', '0069_data_find_links_among'),
    ]
