# Generated by Django 2.2.4 on 2020-09-24 12:04
...
def operation(apps, schema_editor):
    sql = '''create or replace function find_rel(v_user_from_id int, v_level int) returns setof template_tmp1 as 
$$
...
begin 
    ...
    return query 
        insert into tmp1
            ...
            where
                user_from_id=v_user_from_id and user_to_id is not null
    returning *; 
